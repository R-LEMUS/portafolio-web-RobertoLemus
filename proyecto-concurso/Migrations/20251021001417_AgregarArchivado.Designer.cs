...
namespace CoreFixWeb.Migrations
{
    ...
    [Migration("20251021001417_AgregarArchivado")]
    partial class AgregarArchivado
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoreFixWeb.Data.Archivado", b =>
                {
                    ...
                    b.Property<int?>("ReporteID_reporte")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreFixWeb.Data.Archivado", b =>
                {
                    b.HasOne("CoreFixWeb.Data.Reporte", "Reporte")
                        .WithMany()
                        .HasForeignKey("ReporteID_reporte");
